...
const Header = ({handleSidebar}) => {
  return (
    <div className='header'>
      ...
      <FaBars onClick={()=>handleSidebar()} className='__menu' size={26} />
      <img  src="https://pngimg.com/uploads/youtube/small/youtube_PNG15.png" alt="YTlogo" className='__logo'/>
